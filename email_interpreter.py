...
def main():
    ...
    if not messages:
        ...
        for message in messages:
            # create a dictionary object reresenting the email
            msg = service.users().messages().get(userId='me', id=message['id'], format='raw').execute()

            # retreave raw byte data from dictionary object
            ...
            #print("xxxxxxxxxxxxxxxx***next email***xxxxxxxxxxxxxxxx")
